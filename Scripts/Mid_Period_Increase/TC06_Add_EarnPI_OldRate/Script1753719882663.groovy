...
WebUI.click(findTestObject('Object Repository/Mid_period_increase/TC06_Add_EarnPI_OldRate/Page_IBEX Payroll/a__ BACK TO PAYROLL SETUP_ PAYROLL INSTRUCTIONS'))
...
WebUI.click(findTestObject('Object Repository/Mid_period_increase/TC06_Add_EarnPI_OldRate/Page_IBEX Payroll/div_Earning'))

WebUI.click(findTestObject('Object Repository/Mid_period_increase/TC06_Add_EarnPI_OldRate/Page_IBEX Payroll/fw-select_Schedule'))

WebUI.click(findTestObject('Object Repository/Mid_period_increase/TC06_Add_EarnPI_OldRate/Page_IBEX Payroll/div_Occasional'))

WebUI.click(findTestObject('Object Repository/Mid_period_increase/TC06_Add_EarnPI_OldRate/Page_IBEX Payroll/input_Applies to'))

WebUI.click(findTestObject('Object Repository/Mid_period_increase/TC06_Add_EarnPI_OldRate/Page_IBEX Payroll/input_All Departments'))

WebUI.click(findTestObject('Object Repository/Mid_period_increase/TC06_Add_EarnPI_OldRate/Page_IBEX Payroll/fw-select_Input value type'))

WebUI.click(findTestObject('Object Repository/Mid_period_increase/TC06_Add_EarnPI_OldRate/Page_IBEX Payroll/div_Units'))

WebUI.setText(findTestObject('Object Repository/Mid_period_increase/TC06_Add_EarnPI_OldRate/Page_IBEX Payroll/input_Default Value'), 
    '0')

WebUI.click(findTestObject('Object Repository/Mid_period_increase/TC06_Add_EarnPI_OldRate/Page_IBEX Payroll/input_Determined using a formula'))
